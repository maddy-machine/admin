...
public class SettingsActivity extends AppCompatActivity {
    ...
    private void setupClickListeners() {
        ...
        btnEditProfile.setOnClickListener(v -> {
            ...
            // You can create EditProfileActivity later
        ...
        layoutPrivacyPolicy.setOnClickListener(v -> {
            ...
            // You can open a web view or PDF later
        });

        // Terms & Conditions
        layoutTermsConditions.setOnClickListener(v -> {
            Toast.makeText(this, "Terms & Conditions feature coming soon", Toast.LENGTH_SHORT).show();
            // You can open a web view or PDF later
        });
